...
<?php $nr_elevi = count($_SESSION['nume']); ?>
<table cellpadding=5 cellspacing=0 border=0 width="75%">
    <tr>
        <th>Nume</th>
        <th>Prenume</th>
